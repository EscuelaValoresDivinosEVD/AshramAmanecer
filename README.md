...
Sitio en Next.js (exportación estática) con un mapa interactivo: las nubes se abren con el scroll y cada edificio se ilumina y muestra su nombre al pasar el cursor.
...
- `src/app/globals.css`: estilos (brillo, etiquetas, transiciones).
