...
export const places: Place[] = [
  { slug: "cabana-alta", name: "Cabaña Alta", tagline: "Descanso en lo alto de la pradera", image: "/map/buildings/cabana-alta.webp", x: 2236, y: 674, w: 173, h: 137 },
  { slug: "refugio-del-bosque", name: "Refugio del Bosque", tagline: "Un rincón escondido entre los árboles", image: "/map/buildings/refugio-bosque.webp", x: 3532, y: 698, w: 110, h: 77 },
  { slug: "domo-solar", name: "Domo Solar", tagline: "Espacio de encuentro y ceremonia", image: "/map/buildings/domo-naranja.webp", x: 3535, y: 852, w: 442, h: 292 },
  ...
  { slug: "kiosco-del-lago", name: "Kiosco del Lago", tagline: "Meditar junto al agua", image: "/map/buildings/kiosco-lago.webp", x: 2352, y: 1219, w: 362, h: 166 },
  ...
  { slug: "domo-de-meditacion", name: "Domo de Meditación", tagline: "El corazón del Ashram", image: "/map/buildings/domo-negro.webp", x: 2830, y: 1571, w: 536, h: 356 },
  ...
  { slug: "salon-verde", name: "Salón Verde", tagline: "Talleres, yoga y comunidad", image: "/map/buildings/casa-techo-verde.webp", x: 2037, y: 1963, w: 590, h: 506 },
];
